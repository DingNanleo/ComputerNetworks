    ...
    while True:
        try:
            ...
            if pkt_header.type == PacketHeader.TYPE_FILENAME:
                ...
                print(f"PacketHeader: type={pkt_header.type}, seq_num={pkt_header.seq_num}, length={pkt_header.length}, filename={filename}")
                if not filename:
                ...
                print(f"Sent ACK for filename packet: seq={expected_seq}")
                expected_seq += 1
